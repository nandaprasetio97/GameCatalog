package com.nandaprasetio.gamecatalog.presentation.itemdecoration
...
import com.nandaprasetio.gamecatalog.presentation.epoxy.epoxymodel.PlaceholderEpoxyModel
...
class ModifiedEpoxyItemSpacingDecorator(): EpoxyItemSpacingDecorator() {
    ...
    private fun allowItemToUseLeftRightMargin(epoxyModel: EpoxyModel<*>): Boolean {
        return epoxyModel is ItemEpoxyModel || epoxyModel is PlaceholderEpoxyModel
    }
}